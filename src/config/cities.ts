 ...
 *
 * WICHTIG für lokales SEO: Bitte für jede neue Stadt einen WIRKLICH
 * individuellen Text schreiben (mind. "intro" und "localNotes"), keine
 * Kopien aus anderen Städten verwenden. Das ist unten mit Beispieltexten
 * für 5 Städte vorgemacht.
 *
...
export const cities: City[] = [
  {
    ...
    metaTitle: "Schlüsseldienst Seevetal – Türöffnung 24/7 | Türretter-Nord",
    metaDescription:
      "Schlüsseldienst in Seevetal: Türretter-Nord hilft rund um die Uhr bei zugefallenen und abgeschlossenen Türen – transparent, fachgerecht und lokal erreichbar.",
    h1: "Schlüsseldienst Seevetal",
    intro:
      "Türretter-Nord ist in Seevetal und den umliegenden Ortsteilen für Türöffnungen, Schlosswechsel und Hilfe bei verlorenen oder abgebrochenen Schlüsseln im Einsatz. Durch den lokalen Schwerpunkt können wir Anfragen aus dem Gemeindegebiet und dem nahen Umland gezielt bedienen.",
  ...
  },
  {
    ...
    region: "Hamburg",
    metaTitle: "Schlüsseldienst Hamburg-Harburg | Türretter-Nord",
    metaDescription:
      "Schlüsseldienst für Hamburg-Harburg: Türöffnung, Schlosswechsel und Notdienst durch Türretter-Nord – rund um die Uhr telefonisch erreichbar.",
    h1: "Schlüsseldienst Hamburg-Harburg",
    intro:
      "Vom Seevetaler Einsatzschwerpunkt aus bedienen wir auch Teile des Hamburger Südens, insbesondere den Bezirk Harburg, sofern der Einsatzort innerhalb unseres ungefähren 25-km-Radius liegt. Wir helfen bei zugefallenen und abgeschlossenen Türen sowie bei Problemen mit Schlüssel und Schloss.",
  ...
  },
  {
    ...
    name: "Winsen (Luhe)",
    region: "Niedersachsen",
    metaTitle: "Schlüsseldienst Winsen (Luhe) | Türretter-Nord",
    metaDescription:
      "Türretter-Nord für Winsen (Luhe): Hilfe bei Türöffnung, Schlüsselverlust und Schlosswechsel – transparente Preise und 24/7 Erreichbarkeit.",
    h1: "Schlüsseldienst Winsen (Luhe)",
    intro:
      "Winsen (Luhe) liegt im erweiterten lokalen Einsatzgebiet von Türretter-Nord. Bei Türproblemen prüfen wir bei Ihrer Anfrage, ob die konkrete Adresse innerhalb unseres rund 25 km großen Einsatzradius um Seevetal liegt.",
  ...
  },
  {
    ...
    region: "Niedersachsen",
    metaTitle: "Schlüsseldienst Buchholz in der Nordheide | Türretter-Nord",
    metaDescription:
      "Schlüsseldienst für Buchholz in der Nordheide: Türretter-Nord hilft bei Aussperrung, Schlosswechsel und Schlüsselproblemen im lokalen Einsatzgebiet.",
    h1: "Schlüsseldienst Buchholz in der Nordheide",
    intro:
      "Auch Buchholz in der Nordheide gehört je nach genauer Adresse zum Einsatzgebiet rund um Seevetal. Türretter-Nord unterstützt bei zugefallenen oder abgeschlossenen Türen sowie beim Austausch defekter oder unsicherer Schließzylinder.",
  ...
  },
  {
    ...
    name: "Rosengarten",
    region: "Niedersachsen",
    metaTitle: "Schlüsseldienst Rosengarten – Türöffnung | Türretter-Nord",
    metaDescription:
      "Schlüsseldienst in Rosengarten bei Seevetal: Türretter-Nord hilft bei Türöffnungen und Schlossproblemen – transparent und rund um die Uhr erreichbar.",
    h1: "Schlüsseldienst Rosengarten",
    intro:
      "Rosengarten liegt direkt westlich von Seevetal und damit in unserem lokalen Schwerpunktgebiet. Wir helfen bei Aussperrungen, defekten Schlössern, abgebrochenen Schlüsseln und auf Wunsch beim Austausch von Schließzylindern.",
